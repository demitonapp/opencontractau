"""
opencontractau public Python API.
...
Usage::
    ...
    from opencontractau import fetch_releases, list_jurisdictions
...
_JURISDICTION_SCRAPERS: dict[str, str] = {
    "ACT":            "opencontractau.scrapers.act.scraper",
    "QLD_TMR":        "opencontractau.scrapers.qld.tmr",
    "QLD_MULTI":      "opencontractau.scrapers.qld.ckan",
    ...
    "CENTRAL_COAST_NSW": "opencontractau.scrapers.nsw.councils.central_coast",
    "SUTHERLAND_SHIRE":  "opencontractau.scrapers.nsw.councils.sutherland_shire",
    "STIRLING_WA":       "opencontractau.scrapers.wa.councils.stirling",
