"""
opencontractsau public Python API.
...
from opencontractsau.models.ocds import ReleasePackage
...
_JURISDICTION_SCRAPERS: dict[str, str] = {
    ...
    "LOGAN_COUNCIL":   "opencontractsau.scrapers.qld.councils.logan",
    "MORETON_BAY":     "opencontractsau.scrapers.qld.councils.moreton_bay",
    "IPSWICH_COUNCIL": "opencontractsau.scrapers.qld.councils.ipswich",
    "SCENIC_RIM":      "opencontractsau.scrapers.qld.councils.scenic_rim",
    # NSW Local Government (awarded contract registers)
    "SYDNEY_COUNCIL":   "opencontractsau.scrapers.nsw.councils.city_of_sydney",
    "NORTHERN_BEACHES": "opencontractsau.scrapers.nsw.councils.northern_beaches",
    "WOLLONGONG":       "opencontractsau.scrapers.nsw.councils.wollongong",
    "BLACKTOWN":        "opencontractsau.scrapers.nsw.councils.blacktown",
    "CUMBERLAND":       "opencontractsau.scrapers.nsw.councils.cumberland",
    "LIVERPOOL_NSW":    "opencontractsau.scrapers.nsw.councils.liverpool",
    # VIC Local Government (awarded contract registers)
    "MELBOURNE":            "opencontractsau.scrapers.vic.councils.melbourne",
    "MORNINGTON_PENINSULA": "opencontractsau.scrapers.vic.councils.mornington_peninsula",
}
