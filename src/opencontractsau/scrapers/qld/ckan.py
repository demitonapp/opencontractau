...
``scrapers/qld/tmr.py``. Use ``opencontractsau qld tmr`` for TMR data.
"""
...
from opencontractsau.transformers.qld_generic import build_column_map, row_to_release
...
async def scrape(
    ...
    return ReleasePackage(
        uri="https://github.com/demitonapp/opencontractsau/releases/qld/ckan",
