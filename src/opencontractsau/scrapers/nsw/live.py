...
the Playwright driver (opencontractsau.drivers.playwright_nsw) instead.
...
from opencontractsau.transformers.qld import _clean_abn, _parse_au_date, _parse_value
...
async def scrape(
    ...
    return ReleasePackage(
        uri="https://github.com/demitonapp/opencontractsau/releases/nsw/live",
